...
export const CURRENT_USER_CLINIC_ADMIN: User = {
  id: 'u3',
  name: 'Dr. Tazi',
  role: 'clinic_admin',
  avatar: 'https://picsum.photos/id/66/100/100',
  clinicName: 'Clinique du Sourire',
  plan: 'Pro',
  enabledModules: PRO_MODULES,
};
...
export const MOCK_PATIENTS: Patient[] = [
  {
    ...
    medicalHistory: ['Allergie Pénicilline', 'Hypertension'],
  },
  {
    id: 'p2',
    firstName: 'Fatima',
...
export const MOCK_APPOINTMENTS: Appointment[] = [
  {
    ...
    patientId: 'p1',
    doctorId: 'u1',
    start: new Date('2024-01-24T09:00:00'),
    duration: 30,
  ...
  },
  {
    ...
    patientId: 'p3',
    doctorId: 'u1',
    start: new Date('2024-01-24T11:30:00'),
    duration: 15,
...
export const MOCK_DOCUMENTS: MedicalDocument[] = [
  ...
  },
  {
    ...
    patientName: 'Fatima Zahra',
    type: 'Ordonnance',
    fileName: 'Prescription_Soins.pdf',
    date: '15 Jan 2024',
    size: '156 KB',
  },
  {
    ...
    patientName: 'Karim Benali',
    type: 'Radio',
    fileName: 'RetroAlveolaire_36.jpg',
    date: '24 Jan 2024',
    size: '1.1 MB',
  },
];
...
export const MOCK_EXPENSES: Expense[] = [
  ...
  },
  {
    id: '3',
    tenantId: 'mock',
    description: 'Consommables Dentaires',
    category: 'Supplies',
    amount: 1200,
    date: '2024-01-10',
    status: 'Pending',
...
export const MOCK_INVENTORY: InventoryItem[] = [
  ...
  },
  {
    ...
    minThreshold: 10,
    unit: 'Boîtes',
    supplier: 'DentalSupply',
    lastRestock: '15 Jan 2024',
  },
  {
    id: 'i3',
    name: 'Anesthésique Septanest',
    category: 'Consumable',
    quantity: 25,
    minThreshold: 5,
    unit: 'Cartouches',
    supplier: 'MedicalExpress',
    lastRestock: '22 Jan 2024',
  },
];
...
export const MOCK_TENANTS_DETAILED: TenantDetailed[] = [
  {
    id: 'TEN-001',
    name: 'Cabinet Dentaire Amina',
    contactName: 'Dr. Amina',
  ...
  {
    id: 'TEN-003',
    name: 'Ortho Plus Tanger',
    contactName: 'Mme. Bennani',
    email: 'admin@orthoplus.ma',
    plan: 'Starter',
    status: 'Suspended',
    usersCount: 2,
    storageUsed: '0.5 GB',
...
export const MOCK_PLANS: PricingPlan[] = [
  {
    ...
    currency: 'MAD',
    billing: 'Monthly',
    features: ['Agenda', 'Dossiers Patients', 'Documents'],
    activeClinics: 12,
  },
  {
    id: 'p2',
    ...
    currency: 'MAD',
    billing: 'Monthly',
    features: ['Tout Starter', 'Facturation', 'Comptabilité', 'Stock'],
    activeClinics: 25,
    isPopular: true,
  },
  {
    ...
    currency: 'MAD',
    billing: 'Monthly',
    features: ['Tout Pro', 'Assistant IA', 'Support VIP', 'White Label'],
    activeClinics: 5,
  },
];
...
export const MOCK_WEBHOOKS: Webhook[] = [
  {
    id: 'wh1',
    url: 'https://api.clinic-sys.com/hooks/medicom',
...
export const MOCK_TEMPLATES: EmailTemplate[] = [
  {
    id: 't1',
    name: 'Bienvenue Nouveau Cabinet',
    subject: 'Bienvenue sur Medicom !',
...
export const MOCK_NOTIFICATIONS = [
  {
    ...
    message: 'M. Karim Benali a pris RDV pour demain à 10h.',
    time: 'il y a 5 min',
    read: false,
  },
  {
    id: 'n2',
    title: 'Rappel Stock',
    message: 'Le stock de "Gants Latex" est faible (4 boîtes restantes).',
    time: 'il y a 1h',
    read: false,
  },
  {
    id: 'n3',
    title: 'Paiement Reçu',
    message: 'Facture #FAC-2024-001 réglée par Mme. Zahra.',
    time: 'hier',
    read: true,
  },
];
...
export const MOCK_PARTNERS: Partner[] = [
  ...
  {
    id: 'p2',
    name: 'Association Dentistes Casa',
    type: 'Referral',
    commissionRate: 0,
    activeReferrals: 8,
    totalRevenue: 0,
...
export const MOCK_JOBS: CronJob[] = [
  {
    ...
    lastRun: '2024-01-24 00:00',
    nextRun: '2024-01-25 00:00',
    status: 'Idle',
    frequency: 'Daily',
  },
];
...
export const MOCK_BROADCASTS: BroadcastMessage[] = [
  {
    ...
    message: 'Planned maintenance on Sunday.',
    target: 'All',
    status: 'Sent',
    sentAt: '2024-01-20',
  },
...
export const MOCK_FEATURE_REQUESTS: FeatureRequest[] = [
  ...
  },
  {
    id: 'fr2',
    title: 'Mobile App',
    description: 'Native app for iOS',
    votes: 120,
    status: 'Live',
    tags: ['Feature'],
  },
...
export const MOCK_ADDONS: Addon[] = [
  {
    id: 'add1',
    name: 'AI Assistant',
    description: 'Smart clinical notes',
    price: 200,
    activeInstalls: 5,
    status: 'Available',
    icon: 'wand',
  },
  {
    id: 'add2',
    name: 'SMS Pack',
    description: 'Bulk SMS marketing',
    price: 100,
    activeInstalls: 15,
    status: 'Available',
    icon: 'message',
