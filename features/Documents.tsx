    ...
    <div className="space-y-6 font-sans relative">
      ...
      {isUploadModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          ></div>
          <div className="bg-white rounded-[20px]  w-full max-w-md relative z-10 p-6 space-y-6 animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleUploadSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select
                  required
                  className="w-full border-slate-300 rounded-[20px] p-2.5 text-sm border focus:ring-2 focus:ring-blue-500 outline-none bg-white"
              ...
              <button
                ...
                className="w-full py-2.5 bg-blue-600 text-white rounded-[20px] font-medium hover:bg-blue-700  disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                Importer le fichier
              </button>
            </form>
      ...
      >
        <div className="p-6 space-y-6">
          <div>
            ...
            <select
              className="w-full border-slate-300 rounded-[20px] p-2 text-sm border bg-white"
            ...
            <div className="grid grid-cols-1 gap-2">
              {Object.keys(TEMPLATES).map((tmpl) => (
                <button
                  ...
                  className={`text-left px-3 py-2 rounded-[20px] text-sm border transition-colors ${genData.template === tmpl ? 'bg-blue-50 border-blue-200 text-blue-700 font-medium' : 'bg-white border-slate-200 text-slate-600 hover:bg-slate-50'}`}
                >
                  {tmpl}
                </button>
              ))}
          ...
          <div>
            ...
            <textarea
              rows={8}
              className="w-full border-slate-300 rounded-[20px] p-3 text-sm border font-mono bg-slate-50 focus:bg-white transition-colors"
          ...
          <div className="pt-4 flex gap-3">
            ...
            <button
              ...
              className="flex-1 py-2 text-sm font-medium text-white bg-blue-600 rounded-[20px] hover:bg-blue-700  flex justify-center items-center gap-2"
            >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="inline-flex items-center gap-2 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 px-4 py-2 rounded-[20px] text-sm font-medium transition-colors "
          >
      ...
      {/* Filters Bar */}
      <div className="bg-white p-3 rounded-[20px] border border-slate-200  flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="relative flex-1 w-full sm:max-w-md">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 text-sm border border-slate-200 rounded-[20px] focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
        </div>
      ...
      {filteredDocs.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-64 bg-slate-50 border-2 border-dashed border-slate-200 rounded-[20px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {filteredDocs.map((doc) => {
            ...
            return (
              <div
                key={doc.id}
                className="group bg-white rounded-[20px] border border-slate-200 hover:border-blue-300  hover: transition-all flex flex-col overflow-hidden"
              >
