...
const StatCard = ({
  ...
  <div className="bg-white p-5 rounded-[20px] border border-slate-200  flex flex-col justify-between h-32">
    ...
    <div className="space-y-6 relative font-sans">
      ...
      {isPaymentModalOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          ></div>
          <div className="bg-white rounded-[20px]  w-full max-w-md relative z-10 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="block w-full text-lg p-3 border border-slate-300 rounded-[20px] focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
            ...
            <div className="p-4 border-t border-slate-100 bg-slate-50 flex justify-end gap-3">
              <button
                onClick={() => setIsPaymentModalOpen(false)}
                className="px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 rounded-[20px]"
              >
                Annuler
              </button>
              <button
                onClick={submitPayment}
                className="px-4 py-2 text-sm font-medium text-white bg-green-600 hover:bg-green-700 rounded-[20px] "
              >
                Valider
              </button>
            </div>
      ...
      {isPrintModalOpen && selectedInvoice && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
          <div className="bg-white w-full max-w-2xl h-[85vh] flex flex-col rounded-[20px]  overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex-1 overflow-y-auto p-12 bg-slate-100">
              <div className="bg-white  p-10 min-h-[600px] mx-auto max-w-[21cm] text-slate-900 font-sans relative">
                {/* Invoice Layout */}
      ...
      {isExpenseModalOpen && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          ></div>
          <div className="bg-white rounded-[20px]  w-full max-w-sm relative z-10 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
            ...
            <form onSubmit={handleAddExpense}>
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    className="w-full border border-slate-300 rounded-[20px] p-2 text-sm outline-none focus:ring-2 focus:ring-red-500"
                ...
                <div>
                  ...
                  <select
                    className="w-full border border-slate-300 rounded-[20px] p-2 text-sm outline-none focus:ring-2 focus:ring-red-500 bg-white"
              ...
              <div className="p-4 border-t border-slate-100 bg-slate-50 flex justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 text-sm font-medium text-white bg-red-600 hover:bg-red-700 rounded-[20px] "
                >
                  Enregistrer
                </button>
              </div>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-4">
        <div className="flex gap-4 items-center">
          ...
          <div className="flex bg-slate-100 p-1 rounded-[20px]">
            <button
              ...
              className={`px-3 py-1.5 text-xs font-medium rounded-sm transition-all ${activeTab === 'invoices' ? 'bg-white text-blue-700 ' : 'text-slate-500'}`}
            >
              Factures
            </button>
            <button
              onClick={() => setActiveTab('quotes')}
              className={`px-3 py-1.5 text-xs font-medium rounded-sm transition-all ${activeTab === 'quotes' ? 'bg-white text-blue-700 ' : 'text-slate-500'}`}
            >
              Devis
            </button>
            <button
              onClick={() => setActiveTab('expenses')}
              className={`px-3 py-1.5 text-xs font-medium rounded-sm transition-all ${activeTab === 'expenses' ? 'bg-white text-blue-700 ' : 'text-slate-500'}`}
            >
              Dépenses
            </button>
            <button
              onClick={() => setActiveTab('closing')}
              className={`px-3 py-1.5 text-xs font-medium rounded-sm transition-all ${activeTab === 'closing' ? 'bg-white text-blue-700 ' : 'text-slate-500'}`}
            >
              Caisse
            </button>
            <button
              onClick={() => setActiveTab('intelligence')}
              className={`px-3 py-1.5 text-xs font-medium rounded-sm transition-all ${activeTab === 'intelligence' ? 'bg-white text-blue-700 ' : 'text-slate-500'}`}
            >
              Intelligence
            </button>
          </div>
        ...
        <div className="flex gap-3">
          <button className="inline-flex items-center gap-2 bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 px-4 py-2 rounded-[30px] text-sm font-medium transition-colors ">
          ...
          {activeTab !== 'expenses' && activeTab !== 'closing' ? (
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-[20px] text-sm font-medium transition-colors "
            >
      ...
      {activeTab === 'invoices' && (
        /* Invoice List */
        <div className="bg-white rounded-[20px] border border-slate-200  flex flex-col">
          <div className="px-4 py-3 border-b border-slate-200 flex items-center gap-4">
            <div className="relative flex-1 max-w-xs">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-1.5 text-sm border border-slate-200 rounded-[20px] focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
            </div>
          </div>
      ...
      {activeTab === 'closing' && (
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="bg-gradient-to-br from-indigo-900 to-gray-800 rounded-[20px] p-8 text-white ">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-[20px] border border-slate-200 ">
            ...
            <div className="bg-white p-6 rounded-[20px] border border-slate-200  flex flex-col justify-between">
              <div>
              ...
              <button
                ...
                className="w-full py-3 bg-green-600 text-white font-bold rounded-[20px] hover:bg-green-700  flex items-center justify-center gap-2"
              >
      ...
      {activeTab === 'intelligence' && analytics && (
        <div className="space-y-6 animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 bg-white p-6 rounded-[20px] border border-slate-200 ">
            ...
            <div className="bg-white p-6 rounded-[20px] border border-slate-200  flex flex-col">
      ...
      >
        <div className="p-6 space-y-8">
          ...
          <div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-[20px] overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <input
                type="date"
                className="block w-full rounded-[20px] border-slate-300  focus:border-blue-500 focus:ring-blue-500 p-2 border"
            ...
            <div>
              ...
              <select className="block w-full rounded-[20px] border-slate-300  focus:border-blue-500 focus:ring-blue-500 p-2 border">
          ...
          <div className="pt-6 flex gap-3 border-t border-slate-100">
            ...
            <button
              ...
              className="flex-1 py-2.5 bg-blue-600 text-white rounded-[20px] font-medium hover:bg-blue-700  transition-colors flex justify-center items-center gap-2"
            >
