    ...
    <div className="space-y-6 font-sans relative">
      ...
      {isOrderModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          ></div>
          <div className="bg-white rounded-[20px]  w-full max-w-sm relative z-10 p-6 space-y-4">
            ...
            <button
              onClick={submitOrder}
              className="w-full bg-blue-600 text-white py-2 rounded-[20px] font-medium hover:bg-blue-700"
            >
        ...
        <form onSubmit={handleCreateItem} className="p-6 space-y-6">
          <div>
            ...
            <input
              type="text"
              required
              className="w-full border border-slate-300 rounded-[20px] p-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                className="w-full border border-slate-300 rounded-[20px] p-2 text-sm bg-white outline-none"
          ...
          <div className="pt-4 flex gap-3">
            ...
            <button
              type="submit"
              className="flex-1 py-2 bg-blue-600 text-white rounded-[20px] font-medium hover:bg-blue-700 "
            >
              Créer Référence
            </button>
          </div>
        ...
        <div className="flex gap-3">
          <div className="flex bg-slate-100 p-1 rounded-[20px]">
            <button
              ...
              className={`px-3 py-1.5 text-xs font-medium rounded-sm transition-all ${activeTab === 'stock' ? 'bg-white text-slate-900 ' : 'text-slate-500'}`}
            >
              Inventaire
            </button>
            <button
              onClick={() => setActiveTab('orders')}
              className={`px-3 py-1.5 text-xs font-medium rounded-sm transition-all ${activeTab === 'orders' ? 'bg-white text-slate-900 ' : 'text-slate-500'}`}
            >
              Commandes
            </button>
          </div>
      ...
      {activeTab === 'stock' ? (
        <>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <div className="bg-white p-5 rounded-[20px] border border-slate-200 ">
            ...
            <div className="bg-white p-5 rounded-[20px] border border-slate-200  flex flex-col">
              <h3 className="text-sm font-bold text-slate-900 mb-4 flex items-center gap-2">
            ...
            <div className="bg-white p-5 rounded-[20px] border border-slate-200  flex flex-col justify-center items-center text-center">
            ...
            <div className="px-6 py-4 border-b border-slate-200 flex justify-between items-center bg-slate-50/50">
              <div className="flex gap-2">
                {['All', 'Consumable', 'Instrument'].map((cat) => (
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-full border transition-colors ${filter === cat ? 'bg-white text-slate-900 border-slate-300 ' : 'text-slate-500 border-transparent hover:bg-slate-100'}`}
                  >
              ...
              <div className="relative w-64">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-1.5 text-sm border border-slate-300 rounded-[20px] focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
              </div>
            </div>
