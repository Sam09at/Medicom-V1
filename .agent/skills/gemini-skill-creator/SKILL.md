...
description: Reference this skill anytime you are creating any other skill for Antigravity. It enforces structural requirements, YAML frontmatter standards, writing principles, workflow and feedback loops, and output templates.
---
